...
1. Glejtologia stosowana
    ...
    - [Elf](#g_kajetan), podczas gdy druidka trzyma miejsce w kolejce, dość niechętnie udaje się na stronę i wysyła wiadomość do [Larsa](#p_lars). Ten jednak bawi w [Cintrze](#l_cintra) i radzi nam prośbę skierować do [maga-Nifgaardczyka]([Florian](#p_florian_z_vicovaro)), który rzekomo wrócił już do miasta.
    - [Kajetan](#g_kajetan) wysyła swoją sowę z wiadomością do [Magistra Floriana](#p_florian_z_vicovaro), domyślając się, że zadanie go w pracowni w szpitalu. Pyta, czy ten nie byłby skłonny pomóc nam dostać się do miasta.

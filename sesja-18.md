...
1. [Brokilon](#l_brokilon)
    ...
    - Po drodze natykamy się na dwa dziwne znaleziska:
        - pierwszym jest dół w ziemi, w którym piętrzą się ciała [Nilfgaardzkich](#l_nilfgaard) żołnierzy; ich zbroje są pokryte podobną rdzą, jak broń, którą Kajetna z [Ivarem](#p_ivar) kupili od krasnoludów w [Carreras](#l_carreras)
    ...
    - Musząc zatrzymać się na noc, szukamy bezpiecznego miejsca. [Ilana](#g_ilana) znajduje dwa potencjalne miejsca:
        - lekko podmokłą wyrwę w ziemi, przy której leży przewrócone drzewo; na drzewie widać ślady szponów identycznych, jak na wojskowych wozach w [Brugge](#l_m_brugge), a ziemię znaczą ślady kopyt najprawdopodobniej należących do [Bizoktora](Bizoktor) (sic) - oba ślady wiodą z północy na południe

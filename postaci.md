...
- <a id='p_bras' pattern='Bras*'>Bras z Ban Aard</a> - człowiek;
    - mag
    - agent polowy Nowej Kapituły
    - stara się kontrolować sytuację pod Mayeną
- <a id='p_carduin' pattern='Carduin* z Lan Exeter,Carduin*'>Carduin z Lan Exeter</a> - mag, człowiek, drugi w Nowej Kapitule (?)
...
- <a id='p_filippa_eilhart' pattern='Filipp*,Filipp* Eilhart,Eilhart'>Filippa Eilhart</a> - człowiek, mag, członek Kapituły
    ...
    - oślepiona przez Radowida gdy przejął od niej władzę nad Redanią (była regentką)
    - potencjalna winowajczyni nienawiści Radowida do Mocy i magów
...
- <a id='p_geralt' pattern='Geral*,Geral* z Rivii,Biał* Wilk*,Vadgern*'>Greralt z Rivii</a> - człowiek, wiedźmin
    ...
    - miał okazję rozmawiać z pokojowo nastawionym wilkołakiem w Wyzimie
...
- Temeria
    ...
    - Rdestowa Łąka
        ...
        - <a id='p_alfons' pattern='Alfons* Biberveldt*,Alfons*'>Alfons Biberveldt</a> - niziołek, sierota
            - wuj: Andy Biberveldt
    - Maribor
        - <a id='p_kaspar' pattern='Kaspar*'>✝ _Wypychający Stokrotki Wysłannik Rady Regenckiej Redanii Były Tymczasowy Burmistrz Nowobudowanego Dwukroć Zniszczonego Mariboru Z Łaski Regenta Dijkstry Wielmożny Szanowny Pan Wybitny Funkcjonariusz Uniżony Sługa Jego Wysokości Foltesta Błogosławiony Imć Komendant_ Kaspar</a>

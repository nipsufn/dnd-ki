...
- <a id='p_assaire' pattern='Assire var Anahid,Assaire'>Assire var Anahid</a> - człowiek, mag;
    - brat: [Florian](#p_florian_z_vicovaro) var Anahid
...
- [Brokilon](#l_brokilon)
    ...
    - <a id='p_zeff' pattern='Zeff*'>✝ Zeff</a>
        ...
        - zginął/zachorował na plagę/został wykorzystany do eksperymentów próbując pogodzić Driady z mieszkańcami [Brugge](#l_m_brugge)
        - zawinił [Ilanie](#g_ilana), potężnie
        - umarł na [Ciałognilec](#r_cialognilec) w lochach szpitala w [Brugge](#l_m_brugge)
    ...
    - Postaci legendarne
        ...
        - <a id="p_galawain" pattern='Galawain*'>Galawain</a> - duch lasu,
            [Protektor Brokilonu](Bizoktor), którego widzieliśmy w wizji w [Medownej](#l_medowna)
- [Brugge](#l_m_brugge)
    - [Brugge](#l_m_brugge)
        - <a id='p_krol_venzlav_i' pattern='Król* Venzlav* I[^I],Venzlav* I[^I],Król* Venzlav- Pierwsz*,Venzlav* Pierwsz*'>✝ Król Venzlav I</a> - ; król [Brugge](#l_m_brugge)
            Przychylny Driadom
        - <a id='p_krol_venzlav_ii' pattern='Król* Venzlav* II,Venzlav* II,Król* Venzlav* Drugi*,Venzlav* Drugi*'>Król Venzlav II</a> - ; król [Brugge](#l_m_brugge)
        ...
        - <a id='p_lars' pattern='Lars*'>Lars</a> - ; domniemany przywódca szajki najemnych złoczyńców w [Brugge](#l_m_brugge); ukrywa swoją prawdziwą tożsamość pod iluzją, ciągle zmienia wygląd
            - nauczyciel: [Dorregaray](#p_dorregaray)
        - <a id='p_gyf' pattern='Gyf*'>Gyf</a> - człowiek; w sile wieku, lekko siwiejący; kapitan straży granicznej w [Brugge](#l_m_brugge), współpracuje z magiem [Florianem](#p_florian_z_vicovaro)
...
- [Verden](#l_verden)
    ...
    - <a id='p_wehr' pattern='Kapitan* Aleksand* Wehr*,Kapitan* Wehr*,Aleksand* Wehr*,Wehr*'>Kapitan Aleksander Wehr</a> - człowiek; Kapitan ekspedycji karnej przciwko [ghulom](#b_ghul) na północnej granicy we wsi [Skalnica](#l_skalnica)
    - [Lokij](#l_lokij)
...
- [Wyspy Skellige](#l_wyspy_skellige)
    - <a id='p_cerys' pattern='Cerys an Craite,Cerys'>Cerys an Craite</a>
        - jarl wysp [Skellige](#l_wyspy_skellige)
    ...
    - <a id='p_hjalmar' pattern='Hjalmar an Craite,Hjalmar'>Hjalmar an Craite</a> 
        - kandydat do tronu [Skellige](#l_wyspy_skellige)
        - brat [Cerys](#p_cerys)
    - <a id='p_druid_artis' pattern='Druid* Artis*,Artis*'>Druid Artis</a> 
        - druid
        - przewodzi Vildkaarlom
        - popchnął [Skovika](#p_skovik) do zamachu na [Cerys](#p_cerys)

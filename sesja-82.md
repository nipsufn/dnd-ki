...
1. Pogaduchy i ploteczki
	...
	- [Ilana](#g_ilana) prosi [Verdankę](#p_verdanka) o swoją książkę z dzieciństwa - zbiór legend i baśni. Oddaje książkę [Skovikowi](#p_skovik) żeby ten miał też coś bardziej ambitnego do nauki czytania.
2. Wróżenie z fusów
	...
	- [Ilana](#g_ilana) dowiaduje się, że:
		...
		- w wizji ostatniej rozmowy (a raczej kłótni) małżonków ukazanej przez [Galawaina](#p_galawain) córka ma drogą lalkę odzianą w czerń i spiczasty kapelusz
		- [Lloyd](#p_lloyd) z Kapitanem Braunem ukryli w ulach księgi, które później znaleźliśmy
		- księgi należały do uchodzących adeptek magii z [Aretuzy](#l_wyspa_thanedd), niewiele starszych od córki [żołdaka](#p_lloyd)
		- Ellen zarzuca mu, że wydał niewinne dzieci, a następnie, niczym hiena, ukradł ich dobytek - magiczne księgi
		- [Lloyd](#p_lloyd) działał niby zgodnie z rozkazami, jednak żona wygania go, rzucając weń sakiewką ze złotem
		- druidce udaje się poznać wygląd oraz głos żony
		- [Formorian](#p_formorian) zabił rodzinę [Lloyda](#p_lloyd) (razem z resztą mieszkańców) zanim pojawiliśmy się w [Medownej](#l_medowna) po raz pierwszy
	...
	- Na koniec audiencji [druidki](#g_ilana) [Galawain](#p_galawain) mówi jej, że ojczym bardzo ją kocha i jest gotów zdobyć się dla niej na spore poświęcenie. Słowa te są podszyte czymś nieprzyjemym, złowróżbnym, jakby były nie radą, a bardziej przestrogą.
	- [Kajetan](#g_kajetan) wytargował jedno pytanie bez obciążania [starego druida](#p_druid_finarrin) - jak zabezpieczyć bibliotekę w [Craag An](#l_craag_an). Dowiedział się, że:
...
3. Chwila na refleksje
	...
	- Zapytana o jej humor [Enid](#p_enid) odpowiada, że w danej chwili tylko jedno z nich (tj. opiekunów [Ilany](#g_ilana)) "bawi się nożem". Sugeruje, że ona sama ma ostatnio zbyt dużo obowiązków żeby o tym myśleć, co potęguje w [Ilanie](#g_ilana) troskę o [starego druida](#p_druid_finarrin).
	...
	- Następnie [druidka](#g_ilana) odnajduje [Skovika](#p_skovik) szukającego sobie zajęcia w wiosce. Do wieczora para ślęczy nad książką. O dziwo pierwsza lekcja czytania we wspólnym przynosi nad podziw dobre rezultaty.
	- Wieczorem [Kajetan](#g_kajetan) znów nęka [Kaspara](#p_kaspar). Tym razem jednak zamiast poirytowanego sługusa [Dijkstry](#p_dijkstra) odpowiada mu młody, kobiecy głos. We śnie odbywa spotkanie z jego właścicielką - onejromantką, wiedźmą od snów, zatrudnioną przez [Kaspara](#p_kaspar) do zbadania uprzykrzającego życie głosu w głowie.
...
4. Nerwy i dyskusje
	...
	- [Kajetan](#g_kajetan) niechętnie przystaje na ten plan. Uzgadniamy, że wybierzemy się do [Medownej](#l_medowna). Być może nawet rozważymy poproszenie o pomoc magów i [Ivara](#p_ivar) - łącząc siły mamy nadzieję, że uda się ze zmorą rozprawić raz na zawsze.
	- Po śniadaniu [Ilana](#g_ilana) bierze [Finarrina](#p_druid_finarrin) na osobność, na spytki:
		...
		- jeśli przyrzeczona osoba nie przejmie odpowiedzialności [starego druida](#p_druid_finarrin), pakt, na mocy którego druidzi utrzymują równowagę pomiędzy lasem, a resztą wygaśnie, pozwalając [Eithne](#p_eithne) na ofensywę.
		- wilki o inteligentnym spojrzeniu towarzyszące [Galawainowi](#p_galawain) to także wybrańcy protektora, poprzednicy [Finarrina](#p_druid_finarrin)
		...
		- jeżeli [Finarrin](#p_druid_finarrin) odejdzie, [Ilana](#g_ilana) będzie zmuszona przejąć jego rolę i dbać o równowagę między lasem, a ludźmi i driadami
		- to już trzeci raz jak [Finarrin](#p_druid_finarrin) odprawia ten rytuał; [druid](#p_druid_finarrin) poświęcił 16 wiosen by pomóc nam z [Lloydem](#p_lloyd)
		- [Finarrin](#p_druid_finarrin) potwierdza, że [Enid](#p_enid) wykorzystuje [Ivara](#p_ivar) do szperania po [Craag An](#l_craag_an)
	- [Ilana](#g_ilana) jest wściekła, że [mentor](#p_druid_finarrin) nie uprzedził jej o "cenie" każdego pytania i drąży ile czasu mu zostało. Wymusza także obietnicę, że da jej czas aby sama zatroszczyła się o swoje zastępstwo. Tymczasem on ma się oszczędzać i nie ryzykować kolejnymi rytuałami.
	- Uproszony przez [Ilanę](#g_ilana) [Kajetan](#g_kajetan) wysyła wiadomość do [Ivara](#p_ivar). Tym razem się udaje i wiadomość dociera do [adresata](#p_ivar). [Ivar](#p_ivar) obiecuje, że przybędzie tak szybko jak to możliwe.
	- Rozchodzimy się w oczekiwaniu na [Ivara](#p_ivar). [Ilana](#g_ilana) "pożycza" oczy pewnego kruka i rozgląda się po okolicy. Ptak zostaje niemal stratowany w powietrzu przez latającą, białą bestię o czterech nogach wyposażonych w kopyta. Za stworem biegnie znajomy niedźwiedź...

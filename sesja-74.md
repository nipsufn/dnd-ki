...
1. Poranek w [Dorian](#l_dorian)
    ...
    - [Kajetan](#g_kajetan) swoim podszeptywaniem próbuje sprowokować burdę. Zamiast tego udaje mu się sprawić, że jeden z osiłków cichcem podżyna dwóch swoich kamratów.
    ...
    - Jeden ze strażników rozpoznaje [Skovika](#p_skovik), na którego postawił w walkach w Mantikorze. Ponoć wygrał dzięki niemu trochę sztuk złota, więc odpala [wyspiarzowi](#p_skovik) parę groszy na piwo.
...
2. U burmistrza
    ...
    - Burmistrz poznaje, że [Skovik](#p_skovik) podczas ostatniej wizyty posprzątał agentów dijkstry i karze swoim podwładnym mieć nas na oku.
3. Do [Gors Velen](#l_gors_velen), etap II: Rdestowa Łąka
    - Wbrew protestom [Kajetana](#g_kajetan), kupujemy osły i jedziemy do Rdestowej.
    - W drodze mija nas [Remi](#p_remi), więc dołączamy się i dalej podróżujemy już wspólnie.
    - [Remi](#p_remi) jedzie do Biberveltów. Wskazuje nam drogę do folwarku sołtysa.

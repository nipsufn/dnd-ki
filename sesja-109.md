...
2. Wycieczka krajoznawcza
    - Przechodząc przez pobojowisko (12) i identyczną galerę po drugiej stronie placu boju (14), odnajdujemy kilka pomieszczeń wciąż zapieczętowanych przez Aen Drisichean (13, 15, 17).
    ...
    - W pomieszczeniu (15) za drugą galerą (14) natykamy się na zbrojownię identyczną jak w Craag An i cztery rzeźby pierwszych Rycerzy Galawaina. Tam udaje nam się zamienić ceramiczne żetony, które nosił ze sobą Kajetan na kilka magicznych fantów:
    ...
    - Idziemy w miejsce, z którego wyszedł strażnik 1. Przez korytarz (17), na którego końcu stoją dwa posągi rycerzy ze skrzyżowaną bronią, przez otwarte drzwi przechodzimy do eksponatorium (18) - leże strażnika 1 oraz wystawę martwych stworzeń:
    ...
    - Z eksponatorium (18) wychodzą dwa kręte korytarze. Oba prowadzą - bezpośrednio i pośrednio - do kolejnego pomieszczenia (21). Ilana czuje obecność strażnika 0 tuż za ścianą. 
    - Znajdujemy przedsionek (21) - pomieszczenie, do którego dawniej dało się przejść bezpośrednio od wejścia (1) przez zawalony obecnie łuk.
    - Przedsionek (21) to miejsce krwawej jatki. Ściany, sufit i podłogę znaczą stare, dawno wypłowiałe ślady krwi.
...
3. Strażnik 0
    ...
    - {Druidka}Ilana wraca w samą porę, gdy strażnik materializuje się z niebytu. Osaczony i zaskoczony, zostaje momentalnie przykuty do podłogi przygotowanym zaklęciem Kajetana.
    ...
    ![mapaSesja109](https://github.com/nipsufn/dnd-ki-source/raw/master/img/mapaSesja109.jpg "mapaSesja109")
...
4. Kawa na ławę
    ...
    - Próbując znaleźć jakiś wspólny grunt ustalamy, co następuje:
        ...
        - nie jesteśmy zainteresowani tytułem "nadwornego maga [Verden](#l_verden)" dla [Kajetana](#g_kajetan) (wątpimy czy [ten szmaciarz](#p_lars) w ogóle ma lub będzie miał możliwość wywiązać się z takiej obietnicy) ani statkiem na własność
    ...
    - Prowokujemy [Floriana](#p_florian_z_vicovaro) do opuszczenia szpitala przygotowanego do obrony, kusząc go informacją o pięknie wykonanej broni [tej gnidy](#p_lars) o [dwimerytowym](#r_dwimeryt) ostrzu, które rzekomo ukrywa w spelunie, w której właśnie się znajdujemy (na prawdę nosi je przy sobie). [Mag](#p_florian_z_vicovaro) przybędzie tu gdy powiemy mu, że zaczynamy akcję myśląc, że wszyscy wyruszymy do szpitala. W rzeczywistości przygotujemy tu na niego zasadzkę.

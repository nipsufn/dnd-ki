...
2. Rynek
    ...
    - [Myrton, Mistrz Łowców]([Myrton](#p_lord_myrton)) Czarownic/Potworów (jakkolwiek oni się tam teraz chcą zwać) przebija ją mieczem, jednak przychodzi mu to z wyraźnym trudem - zdaje się "grzęznąć" w powietrzu jak w smole.
...
6. [Różyczka](#l_rozyczka) - konfrontacja
    ...
    - Podjudzacz robotników]([Undyr](#p_mlody_kaplan)), którego [Ilana](#g_ilana) rozpoznaje niemal natychmiast, pojawia się z towarzyszem w karczmie nieludzi. Niby-uprzejmie wypytuje [Marię co można zamówić (sprawia wrażenie pytającego jak źle jest).
